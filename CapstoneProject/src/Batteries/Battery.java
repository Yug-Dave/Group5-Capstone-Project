...
import EnergySources.EenergySource;
...
public class Battery {
	...
	private EenergySource energySource;
			...
			public void run() {
				...
				while (true) {
					...
					if (amount + currentCharge <= capacity) {
						...
						// System.out.println(Thread.currentThread().getName() + " charged battery by "
						// + amount
	...
	public void setEnergySource(EenergySource energySource) {
