...
public class ChargingMenu {
    ...
    public void display(Scanner scanner) {
        ...
        while (!backToMain) {
            ...
            System.out.println("3. Raining Weather (Urban Electricity) - Status: " + (isUrbanElectricityOn ? "On" : "Off"));
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    handleEnergySource(scanner, "Raining Weather (Urban Electricity)", isUrbanElectricityOn);
                    break;
                case 4:
                    backToMain = true;
                    break;
